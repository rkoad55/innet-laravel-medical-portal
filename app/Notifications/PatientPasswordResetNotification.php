...
class PatientPasswordResetNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->action('Reset Password', url(config('app.url').route('patient.password.reset', ['token' => $this->token, 'email' => $notifiable->getEmailForPasswordReset()], false)))
