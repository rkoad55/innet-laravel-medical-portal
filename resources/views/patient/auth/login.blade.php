...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      ...
      <a href="" style="display:block"><b>Patient</b>Portal</a>
    </div>
    <div class="card">
      ...
      @endif
        ...
        <form action="{{route('patient.login.post')}}" method="post" role="form">
        @csrf
        ...
        <p class="mb-1">
          <a href="{{url('/patient/password/reset')}}">I forgot my password</a>
        </p>
        <p class="mb-0">
          <a href="{{url('/patient/register')}}" class="text-center">Register a new membership</a>
        </p>
      </div>
    </div>
  </div>
