...
<link rel="stylesheet" href="{{ asset('assets/plugins/fullcalendar/main.min.css') }}">
  ...
  <?php $paitent_appointment = $CentralController->getPatientAppointment(Auth::guard('patient')->user()->id);//dd($doctor_avalibility); ?>
...
<script>
  $(function () {
    ...
    var calendar = new Calendar(calendarEl, {
      ...
      events    : [
        @foreach($paitent_appointment as $key => $value)
        {
          title          : 'Appointment',
