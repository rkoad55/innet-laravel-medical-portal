...
<section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                @include('admin.module.profile.mini-profile')
            </div>
            <!-- /.col -->
            <div class="col-md-9">
                @include('admin.module.profile.basic-information-form')
                @include('admin.module.profile.password-reset')
...
@if(!is_null(Auth::guard('admin')->user()->country))
  var country_value = "{{Auth::guard('admin')->user()->country}}";
@else
...
@if(!is_null(Auth::guard('admin')->user()->state))
  var state_value = "{{Auth::guard('admin')->user()->state}}";
@else
