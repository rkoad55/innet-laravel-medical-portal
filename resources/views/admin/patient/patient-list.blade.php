...
@section('content')
<?php
if(isset($check) && $check == 'Department Patients'){
  $patient = $department_patient;
  // dd($patient);
}else{
  $patient = $CentralController->getAllPatients();
}
 ?>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    //$patient_avalibility = $CentralController->getDoctorAvalibilityById($value->id);
                    $patient_specialization = $CentralController->getSpecializationById($value->depart_id);
                ...
                <tr id="row_{{$value->id}}">
                  ...
                  <td>
                    ...
                    @if(count($patient_specialization))
                        <?php $patient_specialization = implode(", ", array_column($patient_specialization, 'title')); ?>
                      
                        <p><b>Department:</b> {{$patient_specialization}}</p>
                    @else
                  ...
                  <td>
                    <div class="btn-group {{$value->status}}" id="statusBtn_{{$value->id}}">
                      @if($value->status == 1)
