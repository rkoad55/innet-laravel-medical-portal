...
<link rel="stylesheet" href="{{ asset('assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
  ...
  <section class="content">
          ...
          <div class="card card-dark  card-outline">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="{{ url('admin/department/create') }}" class="btn btn-dark">Add Department</a>
              </div>

            </div>
            <!-- /.card-header -->
            <div class="card-body">
                {{ Form::open(array('url' => '/admin/department/position', 'id' => 'department-position', 'role' => 'form')) }}
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr id="row_{{$value->id}}">
                  ...
                  <td>
                    <a href="{{url('/admin/department/'.$value->id.'/edit')}}"><i class="fa fa-fw fa-edit" aria-hidden="true"></i>&nbsp;</a>
                    &nbsp;
                    <a class = "formConfirm" data-toggle="modal" data-target="#modal-default" data-form="#formConfirm-{{$value->id}}-department-row_" data-title="Delete Page" data-message="Are you sure you want to delete this Page?" href="javascript:void(0);"><i class="fa fa-trash" aria-hidden="true"></i> </a>
                  </td>
                  <td>
                    <a href="{{url('/admin/department/'.$value->id.'/doctorlist')}}">Doctors&nbsp;</a>
                    &nbsp;
                    <a href="{{url('/admin/department/'.$value->id.'/patientlist')}}">Patients&nbsp;</a>
                  </td>
      ...
      $.ajax({
      type: "post",
      url: "{{ url('admin/department/change_status') }}",
